/* =========================================================
   fynnhofmann.com – Auth Guard  (servicenow/ edition)
   Include as FIRST <script> in <head> of every page inside
   the servicenow/ folder. Blocks rendering instantly.
   ========================================================= */
(function () {
  'use strict';
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    css.textContent =
      ...
      '.fh-wall h1{font-size:1.7rem;font-weight:600;letter-spacing:-0.01em;margin:0 0 12px}' +
    ...
    document.body.innerHTML =
      '<div class="fh-wall">' +
        ...
        '<div class="fh-debug">' +
          ...
          '<div>Zeit: ' + time + '</div>' +
        '</div>' +
        '<div class="fh-footer">Zugriff protokolliert &middot; ' +
